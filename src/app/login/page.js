...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#0a1628]">
        ...
        <div className="relative z-10">
          <div className="mb-10 flex items-center gap-3">
            <div className="flex h-16 w-16 items-center justify-center overflow-hidden rounded-2xl bg-white/5 ring-1 ring-white/10">
              <img src="/logo.png" alt="FishPoint Logo" className="h-14 w-14 object-contain" />
            </div>
          ...
          <p className="text-gray-400 text-base md:text-lg max-w-lg mb-10 leading-relaxed">
            Ribuan spot memancing terverifikasi dari komunitas angler Indonesia
          </p>
      ...
      {/* ===== RIGHT FORM SIDE ===== */}
      <div className="w-full md:w-[43%] flex items-center justify-center px-6 py-12 md:py-0 md:px-10 lg:px-14">
        <div className="w-full max-w-md border border-[#1e3a5f]/30 bg-[#1a2332]/80 backdrop-blur-xl rounded-3xl p-8 md:p-10 shadow-2xl shadow-black/20">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">Masuk ke FishPoint</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-semibold py-3 rounded-xl transition-all duration-200 shadow-lg shadow-emerald-600/20 hover:shadow-emerald-500/30 active:scale-[0.98] cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
